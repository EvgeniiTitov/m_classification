...
class PreProprocessor:
    ...
    def orient_numbers(image):
        img_r = PreProprocessor.rotate_vertical_image(image)
    ...
    def deskew(image):
        ...
        x, y, w, h = PreProprocessor.crop_size_by_skew(cols, rows, res_x.x)
        # print('r ',rows, 'c ',cols)
        # print('xywh-',x,y,w,h)
    ...
    @staticmethod
    def finalize(image):
        dst = PreProprocessor.deskew(image)
